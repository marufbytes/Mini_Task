...
public class Payment extends JFrame {
    ...
    Payment() {
        ...
        imgLabel.setBounds(380, 90, img1.getIconWidth(), img1.getIconHeight());
        c.add(imgLabel);

        img2 = new ImageIcon(getClass().getResource("/images/MasterCard.png"));
        imgLabel = new JLabel(img2);
        imgLabel.setBounds(465, 90, img2.getIconWidth(), img2.getIconHeight());
        c.add(imgLabel);

        // Fonts
        f1 = new Font("Segoe UI Black", Font.PLAIN, 30);
        f2 = new Font("Segoe UI Semibold", Font.PLAIN, 22);
        ...
        label1.setBounds(180, 20, 500, 50);
        label1.setFont(f1);
        c.add(label1);

        label2 = new JLabel("We Accept Only");
        label2.setBounds(190, 85, 500, 50);
        label2.setFont(f2);
        c.add(label2);

        label2 = new JLabel("Card Details:");
        label2.setBounds(210, 140, 500, 50);
        label2.setFont(f2);
        c.add(label2);

        // Name On Card
        label3 = new JLabel("Card Holder Name");
        label3.setBounds(210, 180, 500, 50);
        label3.setFont(f3);
        c.add(label3);

        tf1 = new JTextField();
        tf1.setBounds(210, 225, 300, 30);
        tf1.setFont(f4);
        c.add(tf1);

        // Card Number
        label3 = new JLabel("Card Number");
        label3.setBounds(210, 255, 500, 50);
        label3.setFont(f3);
        c.add(label3);

        tf2 = new JTextField();
        tf2.setBounds(210, 300, 300, 30);
        tf2.setFont(f4);
        ...
        label3.setBounds(210, 330, 500, 50);
        label3.setFont(f3);
        c.add(label3);

        tf3 = new JTextField();
        tf3.setBounds(290, 342, 90, 30);
        tf3.setFont(f4);
        ...
        label3.setBounds(400, 330, 500, 50);
        label3.setFont(f3);
        c.add(label3);

        pf = new JPasswordField();
        pf.setBounds(450, 342, 80, 30);
