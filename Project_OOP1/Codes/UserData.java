...
public class UserData extends JFrame 
{
    ...
    private String[] column = { "First Name", "Last Name", "Email", "username", "Password", "Date and Time" };
        ...
        try {
            ...
            for (int i = 0; i < totalLines; i++) {
                ...
                if (x.equals("User")) {
                    ...
                    rows[3] = Files.readAllLines(Paths.get(file)).get((i + 3)).substring(20); // username
                    rows[4] = Files.readAllLines(Paths.get(file)).get((i + 4)).substring(9); // Password
